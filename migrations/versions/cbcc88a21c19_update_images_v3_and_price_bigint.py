"""Update Images V3 and Price BigInt

Revision ID: cbcc88a21c19
Revises: adcafb8d7fb5
Create Date: 2025-10-14 03:43:05.681885
...
revision: str = 'cbcc88a21c19'
down_revision: Union[str, Sequence[str], None] = 'adcafb8d7fb5'
...
def upgrade() -> None:
    ...
    op.alter_column('listing', 'price_cents',
